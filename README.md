...
- On the terminal run this command git clone `git@github.com:Outkarm/oop-school-library.git`
...
Feel free to check the [issues page](https://github.com/Outkarm/oop-school-library/issues).
...
If you like this project, Drop a Star and follow for more exciting stuff
